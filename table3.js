...
var svg = d3.select("#table3").append("svg")
.attr("width", width + margin.left + margin.right)
.attr("height", height + margin.top + margin.bottom)
.append("g")
.attr("transform", "translate(" + margin.left + "," + margin.top + ")");

//read in the csv file that containes data from table 3
d3.csv("data_table3.csv", function(error, data) {
